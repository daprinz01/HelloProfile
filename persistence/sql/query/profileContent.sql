...
insert into profile_contents(title, display_title, "description", "url", profile_id, call_to_action_id, "order", content_id, image_url)
values($1, $2, $3, $4, $5, $6, $7, $8, $9) returning *;

-- name: UpdateProfileContent :exec
update profile_contents set title=$1, display_title=$2, "description"=$3, "url"=$4, call_to_action_id=$5, "order"=$6, image_url=$7
where id=$8;
