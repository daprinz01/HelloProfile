...
SELECT b.firstname, b.lastname, b.email, b.username, b."password", b.address, b.city, b.state, b.country, b.image_url as profile_picture, b.is_email_confirmed, b.is_locked_out, b.is_password_system_generated, b.created_at, d."name" as language_name, f."name" as role_name, k."name" as timezone_name, k.zone, m."name" as provider_name, m.client_id, m.client_secret, m.image_url as provider_logo
from users b
